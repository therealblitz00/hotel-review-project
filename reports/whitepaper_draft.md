...
After automated cleaning, **999 reviews** were retained from an initial 1,000 (one dropped for empty review text). Reviews span 38 months (2023-03 to 2026-04), with volume peaking in **2026-03** (86 reviews). Average review length is 35.3 words (median 23.0), suggesting guests invest genuine effort in their feedback.
...
Dominant traveler type: Couple. Average stay: 2.9 nights. Average review length: 31.9 words. Negative share: 5.2%.  
*Marketing action:* Romance packages, late check-out, rooftop dining promotions.

**Social Groups** (131 reviews, avg 8.24/10)  
Dominant traveler type: Group. Average stay: 2.6 nights. Average review length: 33.8 words. Negative share: 6.9%.  
...
Dominant traveler type: Solo traveller. Average stay: 2.4 nights. Average review length: 39.9 words. Negative share: 7.1%.  
...
The 3-class macro F1 (0.5245 for LR) reflects a structural label-signal mismatch: review text at the score-7/score-8 boundary is linguistically near-identical, making the neutral/negative boundary unreliable. Both supervised models nonetheless outperform the VADER baseline (0.4573).

The **binary classifier** (F1-macro 0.6548, CV 0.7019) provides the most deployable model. Its recommended operational use: **auto-flag incoming non-positive reviews within minutes of publication**, triggering a 24-hour management response SLA. This directly addresses the reputational risk posed by the 6.4% negative share and the Booking.com ranking suppression that unresponded negative reviews cause.
...
Latent Dirichlet Allocation (LDA) was applied to all 999 review texts. The vocabulary was built with CountVectorizer (max 3,000 features, 1-2 ngrams, min_df=3, max_df=90%), yielding 1,289 unique terms after hotel-domain and multilingual stop-word filtering. LDA perplexity: **831.94**.

### 5.2 Discovered Topics

| Topic | Reviews | Avg Score | Top Keywords | Marketing Action |
| --- | --- | --- | --- | --- |
| Location & Convenience | 92 | 8.53 | location, breakfast, porto, perfect, bar | Leverage location in SEO content and OTA headline; create 'Porto in 48 hours' city guide. |
| Staff & Service | 341 | 8.52 | location, staff, breakfast, friendly, helpful | Feature staff in OTA listings and social content; nominate for hospitality awards. |
| Value & Overall Experience | 95 | 8.35 | location, walking, recommend, distance, staff | Bundle breakfast in promoted packages; add 'Early Bird' and 'Last Minute' rate tiers. |
| Facilities & Comfort | 95 | 8.13 | uncomfortable, air conditioning, conditioning, air, era | Address air conditioning complaints; publish facilities list clearly on OTA listings. |
| Room Comfort & Cleanliness | 290 | 8.00 | location, staff, breakfast, clean, bed | Introduce standardised room-readiness checklist; pilot mattress upgrade in Budget Double Rooms. |
| Check-in & WiFi | 86 | 7.63 | location, key, station, reception, wifi | Install WiFi repeaters; introduce digital key access; communicate arrival procedures at booking. |

### 5.3 Key Findings

**'Staff & Service'** is the dominant theme (341 reviews, avg 8.52/10). Staff quality is the hotel's primary reputation asset and should be the centrepiece of all marketing communications.

**'Check-in & WiFi'** records the lowest average score (7.63/10). This cluster's negative keywords — WiFi, key, reception, late night — point to specific, fixable operational issues that directly translate into score improvements.
...
1. **WiFi and check-in friction** anchors the lowest-scoring topic ('Check-in & WiFi', avg 7.63/10) and is fixable with targeted infrastructure investment.
...
3. **6.4% of reviews are negative** — a manageable number that the binary sentiment classifier (F1-macro 0.6548) can surface in real time for rapid response.

The hotel's greatest strength — 'Staff & Service' — should be leveraged aggressively in OTA copy, social media, and PR to reinforce brand differentiation and justify premium pricing.
